var decisionTree = function () {
    ...
    function createGraph(jsonData, options) {
        ...
        function smallNode() {
            ...
            // Center the graph
            svgGroupTree.attr("transform", "translate( " + (tfSize + 50) + ", 60), scale( 0.9 )");
        ...
        function appendButtons() {
            $("#" + containerId).append(
                ...
                + "<img src='images/downloadImg.png' id='saveImg' title='保存图片' class='treebtn treebtn5'></button> "
                + "</div>"
            );
        }
